...
<body>
    ...
    <section id="home">
        ...
        <div class="home-right">
            ...
            <div class="orange-button"><a href="#"><span><img src="{{asset('Assets/Home/arrow.png')}}" alt=""> Let's Talk!</span></a></div>
        </div>
    </section>
    ...
    <section id="about">
        <div class="about-text">
            ...
            <div class="orange-button">
                <a href="https://drive.google.com/file/d/1KPm3AJcOb031bTgXwhq94_Mu9Gb6rFMu/view?usp=sharing"><span><img src="{{asset('Assets/Home/arrow.png')}}" alt=""> Download Guidebook</span></a>
            </div>
        </div>
    </section>
    ...
    <section id="jury">
        ...
        <div class="mentor-design">
            <div class="design1">
                ...
                <p class="jury-p">CEO of United Code Of The World (UCOTW)</p>
            </div>
            <div class="design2">
                ...
                <p class="jury-p">CEO of META and founder of Facebook</p>
            </div>
            <div class="design3">
                ...
                <p class="jury-p">CEO of Shopedia and founder of Wizard.io</p>
            </div>
        </div>
    </section>
