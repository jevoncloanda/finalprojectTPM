            ...
            <div class="part-left">
                <form action="{{route('updateLeaderData', ['id'=>$user->id])}}" method="POST" enctype="multipart/form-data">
                    ...
                    <div>
                        ...
                        <div>
                            <div>
                                ...
                                <input type="text" name="leader_birth_place" id="place" value="{{$user->leader_birth_place}}">
                            ...
                            <div>
                                ...
                                <input type="text" name="leader_birth_date" id="date" value="{{$user->leader_birth_place}}">
                    ...
                    <div class="buttons">
                        ...
                        <input class="upload-input" type="file" style="visibility: hidden;" name="leader_CV" id="upload-cv" accept="image/png, image/gif, image/jpeg, application/pdf" onchange="validateFileType()">
                        <input class="upload-input" type="file" style="visibility: hidden;" name="leader_card" id="upload-flazz" accept="image/png, image/gif, image/jpeg, application/pdf" onchange="validateFileType()">
